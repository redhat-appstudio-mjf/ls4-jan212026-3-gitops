...
This repository contains the GitOps deployment manifests for **ls4-jan212026-3**. These Kubernetes manifests define all the resources needed to deploy the application to your OpenShift/Kubernetes cluster via ArgoCD.
...
| 📂 **components/ls4-jan212026-3/** | Kustomize base and overlays for all Kubernetes resources |
...
|----------|------|-------------|
| 🖥️ **Deployment** | `ls4-jan212026-3` | Streamlit UI application |
| 🦙 **Deployment** | `ls4-jan212026-3-llama-stack` | Llama Stack inference server |
| 🦙 **Deployment** | `ls4-jan212026-3-ollama` | Ollama for safety/guardrails |
| ☸️ **Deployment** | `ls4-jan212026-3-mcp-server` | Kubernetes MCP Server |
| 🌐 **Services** | Various | Internal service networking |
| 🔀 **Route** | `ls4-jan212026-3` | External access to Streamlit UI |
| 🔐 **RBAC** | `ls4-jan212026-3-mcp-*` | Permissions for cluster introspection |
| 💾 **PVC** | `ls4-jan212026-3-ollama-data` | Persistent storage for Ollama models |
...
| Resource | Link |
|----------|------|
| 📝 **Source Repository** | [https://github.com/redhat-appstudio-mjf/ls4-jan212026-3](https://github.com/redhat-appstudio-mjf/ls4-jan212026-3) |
